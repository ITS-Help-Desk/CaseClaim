...
def generate_casedist_plot(claims: list[CheckedClaim], month: int, day: int):
    """
    Generate a case distribution graph given a month and day.

    Args:
        month   The month to start from as an int
        day     The dat to start from as an int
        claims  A list of checked claims generated by CheckedClaim.search()

    Returns:
        A file stream of bytes for a png of a case distribution graph
    """
